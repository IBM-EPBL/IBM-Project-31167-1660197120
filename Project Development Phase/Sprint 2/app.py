...
app.config['hostname'] = '125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud'
app.config['port'] = '30426'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'cwy77416'
app.config['pwd'] = '4zg0yQJwQ5ZQMwki'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=30426;protocol=tcpip;\
            uid=cwy77416;pwd=4zg0yQJwQ5ZQMwki;security=SSL'
...
def login():
    ...
    if request.method == 'POST' :
        ...
        # sendmail("hello magesh","magesh266@gmail.com")
        print(dictionary)
        
        if account:
            session['loggedin'] = True
            session['id'] = dictionary["USERID"]
